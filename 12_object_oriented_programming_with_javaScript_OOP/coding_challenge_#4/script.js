...
const acc1 = new Account('Nitheesh', 'EUR', 1111);

acc1.deposit(250);
acc1.withdraw(140);
acc1.requestLoan(1000);
acc1.approveLoan(1000); // The approveLoan still can be accessed outside the class but is kind of an internal method and in real world these should not be acceced outside of th the class
console.log(acc1);
*/
//////////////////////////////////////////////
...
// 3. Public methods
// 4. Private methods
// There is also a static version of these four
/*
class Account {
  locale = navigator.language;
  bank = 'Bankist';
  #movements = [];
  #pin; // For something that we get as argument we can just declare the private field like decalring a let variable
  ...
  getMovements() {
    // not chainable, but still call as the last method in the chain
  ...
  static #test() {
    // Example for static private method, for public static method just remove the #
    console.log('TEST');
  }
}
...
const movements = acc1
  ...
  .withdraw(4000)
  .getMovements();
//acc1.movements = []; // this will erase the entire array, this is how manipulation outside the class works and we use public class for this
console.log(acc1);
...
console.log(rivian.speedUS); // The child class also inherits the getters and setters of the parent class
