...
console.log('Nitheesh Vikraman'.split(' '));

const [firstName, lastName] = 'Nitheesh Vikraman'.split(' ');
...
capitalization('nitheesh vikraman');

// Padding
const message = 'Go to gate 23!';
console.log(message.padStart(20, '+').padEnd(30, '+'));
console.log('Nitheesh'.padStart(20, '+').padEnd(30, '+'));

// Masking credit card using the methods learnt above
...
console.log(maskCredit(193845850));
console.log(maskCredit(40852895670));
console.log(maskCredit('203385818741091'));

// Repeat
const message2 = 'Bad weather... All Departures Delayed...';
console.log(message2.repeat(4));
console.log('Nitheesh'.repeat(5));
...
const airline = 'Emirates UAE';

console.log(airline.toLocaleLowerCase());
console.log(airline.toUpperCase());

// Fix capitalization in name
const passenger = 'NiThEesH'; //Nitheesh
...
// Comparing emails
const email = 'hello@nitheesh.io';
const loginEmail = ' Hello@Nitheesh.Io \n';
...
console.log(new String('Nitheesh'));
console.log(typeof new String('Nitheesh'));

console.log(typeof new String('Nitheesh').slice(1));
*/
///////////////////////////////////////
// Coding Challenge #3
...
console.log(new Set('NitheeshVikraman').size);
*/
///////////////////////////////////////
// Coding Challenge #2
...
let openStr = `We are openn on ${properties.length} days:`;
...
//Arrays
const users = [{ name: 'Nitheesh', email: '18nithe18@gmail.com' }];
