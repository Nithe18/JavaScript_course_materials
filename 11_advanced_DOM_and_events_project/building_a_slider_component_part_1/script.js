...
tabsContainer.addEventListener('click', function (e) {
  ...
  // Active content area
  document
    .querySelector(`.operations__content--${clicked.dataset.tab}`) // the dataset property allows to access the data attribute in the html so data-tab will beaccesed
...
// changing the size of the slider so all the slides acan be vissible (easy for implementation)
...
h1.closest('.header').style.background = 'var(--gradient-secondary)'; // css property
...
}); // click h1 and the scale reduces
*/
